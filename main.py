...
if __name__ == '__main__':
    ...
    start = time.time()
    """O_pct, X_pct = heur_test(collective_utility, evasive_utility, n, 100)
    print("collective vs. evasive: ", O_pct, X_pct)
    O_pct, X_pct = heur_test(collective_utility, conqueror_utility, n, 100)
    print("collective vs. conqueror: ", O_pct, X_pct)
    O_pct, X_pct = heur_test(avg_dist_utility, conqueror_utility, n, 100)
    print("avg_dist vs. evasive: ", O_pct, X_pct)
    O_pct, X_pct = heur_test(avg_dist_utility, conqueror_utility, n, 100)
    print("avg_dist vs. evasive: ", O_pct, X_pct)
    O_pct, X_pct = heur_test(avg_dist_utility, collective_utility, n, 100)
    print("avg_dist vs. collective: ", O_pct, X_pct)
    O_pct, X_pct = heur_test(collective_utility, avg_dist_utility,  n, 100)
    print("collective vs. avg_dist: ", O_pct, X_pct)"""
    runtime = time.time() - start
